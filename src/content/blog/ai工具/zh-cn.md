...
这是我用的比较多的一个模型，多模态支持，qwen3.8max,2.4T的开源模型，识图有了很大进步，思维链和qwen 3.7max相比进步非常大，工具调用能力很强，在其他大模型疯狂卷coding和agent的情况下，3.8max的写作水平竟然有提升！建议下载qwen studio而不是千问。国内使用免费，就是一贯的阿里风格，ui 真的很丑。建议使用国外站。目前已经成为我手机端最常用的大模型
...
最新旗舰：doubao 2.1 pro
豆包在c端拥有绝对多用户占比，生图水平 国内T0 级别，毋庸置疑。有一说一字节在视频领域确实牛逼，但是收费价格你是认真的吗？比kimi还贵，再加点我可以用gpt了，为什么还要用你？而且你这个跑分比opus 4.6还高？开什么玩笑，我让他帮我生成一个pdf，排版和ui有非常大的问题，算了吧，依旧那句话，只适合日常用，毕竟操作足够傻瓜，学术和代码请换一家模型
...
新模型   Gemini 3.7 flash

需要梯子，多模态能力非常强，拥有非常好的前端审美，就是写后端能力不行，注册需要谷歌邮箱（国外软件通信证）。pro依旧难产，google你在干什么，目前3.7没有对免费用户开放，等着吧

如果因为地区原因无法使用，建议转到 [Google ai studio](https://aistudio.google.com/prompts/new_chat)

[Claude](https://claude.com/)

最新旗舰：Claude fable 5, opus 5

需要梯子,不当人的公司，把我的账号给封了，没有任何解释，fable 5确实好用，但是你现在只支持api调用了，这个价格一般人根本用不起。同时claude code还被曝出隐私泄露问题，你tm....
