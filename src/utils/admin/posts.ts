...
function insertMarkdownSnippet(type: string) {
  ...
  const snippets: Record<string, () => void> = {
    ...
    "tip-note": () => insertAtCursor(textarea, ":::note\n这里填写注意内容\n:::\n"),
    "tip-important": () => insertAtCursor(textarea, ":::important\n这里填写重要内容\n:::\n"),
    "tip-warning": () => insertAtCursor(textarea, ":::warning\n这里填写警告内容\n:::\n"),
    "tip-caution": () => insertAtCursor(textarea, ":::caution\n这里填写危险内容\n:::\n"),
    "tip-title": () => insertAtCursor(textarea, ":::tip[自定义标题]\n这里填写提示内容\n:::\n"),
