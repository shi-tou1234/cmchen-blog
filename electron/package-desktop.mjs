...
if (readFileSync(indexHtml, 'utf8').includes(`="${webBase}`)) {
  console.error(`[desktop] dist 是网页版形态（${webBase} 前缀）：先运行 pnpm run build:desktop 再打包`);
  process.exit(1);
}
...
// 应用图标（≥256 的正方形 png，electron-builder 自动转 ico）
